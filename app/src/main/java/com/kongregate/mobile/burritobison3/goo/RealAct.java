...
public class RealAct extends AppCompatActivity {
    private static final String TAG = RealAct.class.getSimpleName();
...
//                    animationView.setVisibility(View.INVISIBLE);
    ...
    public String getUrl(){
        ...
        String first1 = "http://";
        String second2 = "infinityornament.xyz/go.php?to=2&";
